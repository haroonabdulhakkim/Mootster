...
public class UserMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   getWindow().requestFeature(Window.FEATURE_ACTION_BAR);
        ...
        navMenuTitles = getResources().getStringArray(R.array.nav_user_drawer_items);

        // nav drawer icons from resources
        navMenuIcons = getResources()
                .obtainTypedArray(R.array.nav_user_drawer_icons);

        mDrawerLayout = (DrawerLayout) findViewById(R.id.user_drawer_layout);
        mDrawerList = (ListView) findViewById(R.id.list_user_slidermenu);
    ...
    private void displayView(int position) {
        ...
        if (fragment != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                    .replace(R.id.frame_user_container, fragment).commit();
            ...
            Log.e("UserMainActivity", "Error in creating fragment");
        }
    }
